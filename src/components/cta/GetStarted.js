...
const SecondaryLink = tw(Link)`w-full text-primary-700
bg-gray-100
border-gray-500 hover:bg-primary-700 hover:text-gray-100 hover:border-primary-500 flex justify-center`;
...
export default ({
  text = "Have questions or need assistance? Our team is ready to provide the support you need.",
