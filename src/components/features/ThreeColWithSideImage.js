...
export default ({
  ...
  const defaultCards = [
    ...
    },
    {
      ...
      title: "Customizable",
      description:
        "Our products and services are tailored to your specific requirements, ensuring personalized solutions.",
    },
    {
      imageSrc: ReliableIconImage,
      title: "Reliable",
      description:
        "We deliver consistent quality, timely deliveries, and dependable customer support.",
    },
    {
