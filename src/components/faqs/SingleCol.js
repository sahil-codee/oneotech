...
import {
  ...
  ContentWithPaddingXl as ContentWithPaddingXlBase,
...
export default ({
  ...
  description = "We understand you may have questions about our products and services. Here, we've compiled answers to some of the most frequently asked questions about our offerings as a supplier of nylon cable ties, cable tie mounts, and DIN rails.",
  faqs = [
    {
      question: "What types of products do you trade?",
      answer:
        "We specialize in exporting a range of industrial and consumer goods, including nylon cable ties, cable tie mounts, and DIN rails. We ensure high-quality products for our global clients.",
    },
    {
